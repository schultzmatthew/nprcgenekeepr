#' Helper function to remove group numbers when all available animals have been used
#'
...
#' formed. Each list member is initially populated with a integer vector 1:numGrp.
