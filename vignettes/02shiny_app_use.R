...
## ----eopening-screen-top, eval = TRUE, fig.width = 6.5, echo = FALSE----------
img <- png::readPNG("./shiny_app_use/opening_screen_top.png")
grid::grid.raster(img)


## ----eopening-screen-middle, eval = TRUE, fig.width = 6.5, echo = FALSE-------
img <- png::readPNG("./shiny_app_use/opening_screen_middle.png")
grid::grid.raster(img)


## ----eopening-screen-bottom, eval = TRUE, fig.width = 5.5, echo = FALSE-------
img <- png::readPNG("./shiny_app_use/opening_screen_bottom.png")
grid::grid.raster(img)


## ----eexamplePedigreeTutorial, eval = TRUE, fig.width = 5.5, fig.height = 2, echo = FALSE----
img <- readPNG("./shiny_app_use/examplePedigreeTutorial.png")
grid.raster(img)


## ----eexamplePedigreeTutorial-with_alleles, eval = TRUE, fig.width = 5.5, fig.height = 2, echo = FALSE----
img <- readPNG("./shiny_app_use/examplePedigreeTutorial_with_alleles.png")
grid.raster(img)


## ----eopening-screen-top-red-oval, eval = TRUE, fig.width = 5.5, echo = FALSE----
...
## ----example-pedigree, eval = TRUE, fig.width = 2.5, echo = FALSE-------------
img <- png::readPNG("./shiny_app_use/input_example_pedigree_xlsx.png")
grid::grid.raster(img)


## ----example-pedigree-minParentAgeSequence, eval = TRUE, fig.width = 11, echo = FALSE----
img <- png::readPNG("./shiny_app_use/input_minParentAgeSequence.png")
grid::grid.raster(img)


## ----read-and-check-pedigree, eval = TRUE, fig.width = 2.5, echo = FALSE------
...
## ----pb-10-rows-display-unknown-ids, eval = TRUE, fig.width = 5.5, echo = FALSE----
img <- png::readPNG("./shiny_app_use/pb_10_rows_display_unknown_ids.png")
grid::grid.raster(img)


## ----unknown-displayed, eval = TRUE, fig.width = 5, fig.height = 2, echo = FALSE----
img <- png::readPNG("./shiny_app_use/pb_unknown_displayed.png")
grid::grid.raster(img)


## ----no-unknown-displayed, eval = TRUE, fig.width = 5, fig.height = 2, echo = FALSE----
img <- png::readPNG("./shiny_app_use/pb_no_unknown_displayed.png")
grid::grid.raster(img)


## ----focal-animal-text-box, eval = TRUE, fig.width = 5, echo = FALSE----------
...
## ----selection-large-focal-group, eval = TRUE, fig.width = 4, fig.height = 2, echo = FALSE----
img <- png::readPNG("./shiny_app_use/pb_selection_large_focal_group.png")
grid::grid.raster(img)


## ----select-trim-for-focal-animals, eval = TRUE, fig.width = 6, echo = FALSE----
img <- png::readPNG("./shiny_app_use/pb_select_trim_for_focal_animals.png")
grid::grid.raster(img)


## ----trimmed-for-focal-animals, eval = TRUE, fig.width = 4, fig.height = 2, echo = FALSE----
...
## ----age-plot, eval = TRUE, fig.width = 8.0, echo = FALSE---------------------
img <- png::readPNG("./shiny_app_use/age_plot.png")
grid::grid.raster(img)


## ----gva-calculating, eval = TRUE, fig.width = 8, echo = FALSE----------------
img <- png::readPNG("./shiny_app_use/gva_calculating.png")
grid::grid.raster(img)


## ----gva-first-high-value, eval = TRUE, fig.width = 8.0, echo = FALSE---------
img <- png::readPNG("./shiny_app_use/gva_first_high_value.png")
grid::grid.raster(img)


## ----gva-high-and-low-value, eval = TRUE, fig.width = 5.5, fig.height = 1.5, echo = FALSE----
img <- png::readPNG("./shiny_app_use/gva_high_and_low_value.png")
grid::grid.raster(img)


## ----ss-first-view, eval = TRUE, fig.width = 8.0, echo = FALSE----------------
img <- png::readPNG("./shiny_app_use/ss_first_view.png")
grid::grid.raster(img)


## ----ss-kinship-matrix, eval = TRUE, fig.width = 6, fig.height = 2, echo = FALSE----
img <- png::readPNG("./shiny_app_use/ss_kinship_matrix.png")
grid::grid.raster(img)


## ----first-order-relationships, eval = TRUE, fig.width = 5, echo = FALSE------
img <- png::readPNG("./shiny_app_use/ss_first_order_relationships.png")
grid::grid.raster(img)


## ----female-founders, eval = TRUE, fig.width = 5, fig.height = 2, echo = FALSE----
img <- readPNG("./shiny_app_use/ss_female_founders.png")
grid.raster(img)


## ----ss-trimmed-all-plots, eval = TRUE, fig.width = 8, echo = FALSE-----------
img <- png::readPNG("./shiny_app_use/ss_trimmed_all_plots.png")
grid::grid.raster(img)


## ----ss-export-mean-kinship-coef-hist-plot, eval = TRUE, fig.width = 5, echo = FALSE----
img <- png::readPNG(
  "./shiny_app_use/ss_export_mean_kinship_coefficient_histogram.png")
grid::grid.raster(img)


## ----breeding-group-first-view, eval = TRUE, fig.width = 7, echo = FALSE------
img <- png::readPNG("./shiny_app_use/breeding_group_first_view.png")
grid::grid.raster(img)


## ----breeding-group-1, eval = TRUE, fig.width = 8, echo = FALSE---------------
img <- png::readPNG("./shiny_app_use/breeding_group_1.png")
grid::grid.raster(img)


## ----breeding-group-6-infants-with-dam, eval = TRUE, fig.width = 6, echo = FALSE----
img <- png::readPNG("./shiny_app_use/breeding_group_6_infants_with_dam.png")
grid::grid.raster(img)


## ----breeding-group-first-group-no-kinship-seeds-indicated, eval = TRUE, fig.width = 8.5, echo = FALSE----
img <- png::readPNG("./shiny_app_use/breeding_group_first_group_no_kinship_seeds_indicated.png")
grid::grid.raster(img)


## ----breeding-group-6-seed-grps-grp-6-kinship, eval = TRUE, fig.width = 8.5, echo = FALSE----
