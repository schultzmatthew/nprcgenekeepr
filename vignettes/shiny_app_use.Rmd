...
vignette: >
  ...
  %\VignetteIndexEntry{Shiny Application for Genetic Management} 
...
```{r eopening-screen-top, eval = TRUE, fig.width = 2.5, fig.height = 3.5, echo = FALSE}
...
```{r eopening-screen-middle, eval = TRUE, fig.width = 2.5, fig.height = 3.5, echo = FALSE}
...
```{r eopening-screen-bottom, eval = TRUE, fig.width = 2.5, fig.height = 3.5, echo = FALSE}
...
```{r eopening-screen-top-red-oval, eval = TRUE, fig.width = 2.5, fig.height = 3.5, echo = FALSE}
...
```{r pb-100-rows-display-unknown-ids, eval = TRUE, fig.width = 2.5, fig.height = 3.5, echo = FALSE}
img <- readPNG("./shiny_app_use/pb_100_rows_display_unknown_ids.png")
grid.raster(img)
```
...
```{r age-plot, eval = TRUE, fig.width = 2.5, fig.height = 3.5, echo = FALSE}
...
```{r gva-calculating, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
...
```{r gva-first-high-value, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
...
```{r gva-high-and-low-value, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
...
```{r ss-first-view, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
...
```{r ss-kinship-matrix, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
...
```{r ss-trimmed-all-plots, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
...
```{r breeding-group-first-view, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
...
```{r breeding-group-1, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
...
```{r breeding-group-6-infants-with-dam, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
...
```{r breeding-group-first-group-no-kinship-seeds-indicated, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
...
```{r breeding-group-6-seed-grps-grp-6-kinship, eval = TRUE, fig.width = 4, fig.height = 2.5, echo = FALSE}
