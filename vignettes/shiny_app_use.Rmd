...
## Notes regarding feedback from Amanda on 20200204
...
## 
## I am going to write a seperate tutorial explicitely for the consortium 
...
```{r child = "./manual_components/_online_documentation.Rmd", ref = "online_documentation", results = 'markup' , include = TRUE}
```
...
```{r child = "./manual_components/_running_shiny_application.Rmd", ref = "running_shiny_application"}
```
