---
title: "National Primate Research Centers' GeneKeepR:"
subtitle: "A Shiny Application for Genetic Management of Colonies"
author: "R. Mark Sharp"
output:
  html_document:
    df_print: paged
...
```{r eopening-screen-top, eval = TRUE, fig.width = 6.5, fig.height = 7, echo = FALSE}
img <- png::readPNG("./shiny_app_use/2opening_screen_top.png")
...
```{r eopening-screen-middle, eval = TRUE, fig.width = 6.5, fig.height = 7, echo = FALSE}
img <- png::readPNG("./shiny_app_use/2opening_screen_middle.png")
grid::grid.raster(img)
...
img <- png::readPNG("./shiny_app_use/2opening_screen_bottom.png")
grid::grid.raster(img)
...
img <- png::readPNG("./shiny_app_use/2pb_10_rows_display_unknown_ids.png")
grid::grid.raster(img)
...
img <- png::readPNG("./shiny_app_use/2pb_select_trim_for_focal_animals.png")
grid::grid.raster(img)
...
img <- png::readPNG("./shiny_app_use/2ss_first_view.png")
grid::grid.raster(img)
...
img <- png::readPNG("./shiny_app_use/2ss_trimmed_all_plots.png")
grid::grid.raster(img)
...
```{r breeding-group-6-seed-grps-grp-6-kinship, eval = TRUE, fig.width = 5.5, echo = FALSE}
