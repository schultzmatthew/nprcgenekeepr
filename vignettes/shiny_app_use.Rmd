...
```{r bg-first-view, eval = TRUE, fig.width = 7, echo = FALSE}
img <- png::readPNG("./shiny_app_use/bg_first_view.png")
grid::grid.raster(img)
...
```{r bg-1, eval = TRUE, fig.width = 8, echo = FALSE}
img <- png::readPNG("./shiny_app_use/bg_1.png")
grid::grid.raster(img)
...
```{r bg-6-infants-with-dam, eval = TRUE, fig.width = 6, echo = FALSE}
img <- png::readPNG("./shiny_app_use/bg_6_infants_with_dam.png")
grid::grid.raster(img)
...
```{r bg-first-group-no-kinship-seeds-indicated, eval = TRUE, fig.width = 8.5, echo = FALSE}
img <- png::readPNG("./shiny_app_use/bg_first_group_no_kinship_seeds_indicated.png")
grid::grid.raster(img)
...
```{r bg-6-seed-grps-grp-6-kinship, eval = TRUE, fig.width = 8.5, echo = FALSE}
img <- png::readPNG("./shiny_app_use/bg_6_seed_grps_grp_6_kinship.png")
grid::grid.raster(img)
