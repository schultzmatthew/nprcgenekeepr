...
output:
  ...
  html_document:
    df_print: paged
vignette: "%\\VignetteEngine{knitr::rmarkdown_notangle}\n%\\VignetteIndexEntry{Genetic
  Management Tools -- Shiny App} \n%\\usepackage[UTF-8]{inputenc}\n"
---
...
![](./shiny_app_use/images/opening_screen_top.png)
...
![](./shiny_app_use/images/opening_screen_middle.png)
...
![](./shiny_app_use/images/opening_screen_bottom.png)
...
![](./shiny_app_use/images/opening_screen_top_red_oval.png)
...
img <- readPNG("./shiny_app_use/images/input_example_pedigree_xlsx.png")
grid.raster(img)
```
...
img <- readPNG("./shiny_app_use/images/input_minParentAgeSequence.png")
grid.raster(img)
```
...
img <- readPNG("./shiny_app_use/images/read_and_check_pedigree.png")
grid.raster(img)
```
...
![](./shiny_app_use/images/pb_100_rows_display_unknown_ids.png)
...
_U_ and are following with a left alphnumeric string of five places. 
...
img <- readPNG("./shiny_app_use/images/pb_unknown_displayed.png")
grid.raster(img)
```
...
img <- readPNG("./shiny_app_use/images/pb_no_unknown_displayed.png")
grid.raster(img)
```
...
img <- readPNG("./shiny_app_use/images/pb_focal_animal_text_box.png")
grid.raster(img)
```
...
img <- readPNG("./shiny_app_use/images/pb_5_focal_animals_small.png")
grid.raster(img)
```
...
img <- readPNG("./shiny_app_use/images/pb_selection_large_focal_group.png")
grid.raster(img)
```
...
img <- readPNG("./shiny_app_use/images/pb_select_trim_for_focal_animals.png")
grid.raster(img)
```
...
img <- readPNG("./shiny_app_use/images/pb_trimmed_for_focal_animals.png")
grid.raster(img)
```
...
![](./shiny_app_use/images/age_plot.png)
...
![](./shiny_app_use/images/gva_calculating.png)
...
![](./shiny_app_use/images/gva_first_high_value.png)
...
![](./shiny_app_use/images/gva_high_and_low_value.png)
...
![](./shiny_app_use/images/ss_first_view.png)
*********

The __Export Kinship Matix__ button creates a CSV file that has a row and
column for each individual in the genetic analyis plus a first row 
...
img <- readPNG("./shiny_app_use/images/ss_first_order_relationships.png")
grid.raster(img)
```
...
![](./shiny_app_use/images/ss_kinship_matrix.png)
*********
...
![](./shiny_app_use/images/ss_trimmed_all_plots.png)
...
![](./shiny_app_use/images/breeding_group_first_view.png)
...
![](./shiny_app_use/images/breeding_group_1.png)
*********
...
![](./shiny_app_use/images/breeding_group_6_infants_with_dam.png)
...
![](./shiny_app_use/images/breeding_group_first_group_no_kinship_seeds_indicated.png)
...
![](./shiny_app_use/images/breeding_group_6_seed_grps_grp_6_kinship.png)
