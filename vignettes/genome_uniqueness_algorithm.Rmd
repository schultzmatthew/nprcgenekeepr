...
![Generation of a vector of five gametes from one parent. Showing how the transmission vectors (row 2) determine which alleles are passed from the parental chromosomes (row 1) to form the final vector of transmitted alleles (row 4).](../inst/application/www/GeneDrop.png)
