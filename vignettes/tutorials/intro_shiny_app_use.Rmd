...
![](../../inst/extdata/shiny_app_tutorial/images/pb_100_rows_display_unknown_ids.png)
...
img <- readPNG("../../inst/extdata/shiny_app_tutorial/images/pb_unknown_displayed.png")
grid.raster(img)
```
...
img <- readPNG("../../inst/extdata/shiny_app_tutorial/images/pb_no_unknown_displayed.png")
grid.raster(img)
```
...
img <- readPNG("../../inst/extdata/shiny_app_tutorial/images/pb_focal_animal_text_box.png")
grid.raster(img)
```
...
img <- readPNG("../../inst/extdata/shiny_app_tutorial/images/pb_5_focal_animals_small.png")
grid.raster(img)
```
...
img <- readPNG("../../inst/extdata/shiny_app_tutorial/images/pb_selection_large_focal_group.png")
grid.raster(img)
```
...
img <- readPNG("../../inst/extdata/shiny_app_tutorial/images/pb_select_trim_for_focal_animals.png")
grid.raster(img)
```
...
img <- readPNG("../../inst/extdata/shiny_app_tutorial/images/pb_trimmed_for_focal_animals.png")
grid.raster(img)
```
...
![](../../inst/extdata/shiny_app_tutorial/images/gva_calculating.png)
...
![](../../inst/extdata/shiny_app_tutorial/images/gva_first_high_value.png)
...
![](../../inst/extdata/shiny_app_tutorial/images/gva_high_and_low_value.png)
...
![](../../inst/extdata/shiny_app_tutorial/images/ss_first_view.png)
*********
...
img <- readPNG("../../inst/extdata/shiny_app_tutorial/images/ss_first_order_relationships.png")
grid.raster(img)
```
...
![](../../inst/extdata/shiny_app_tutorial/images/ss_kinship_matrix.png)
*********
...
![](../../inst/extdata/shiny_app_tutorial/images/ss_trimmed_all_plots.png)
...
![](../../inst/extdata/shiny_app_tutorial/images/breeding_group_first_view.png)
...
![](../../inst/extdata/shiny_app_tutorial/images/breeding_group_6_infants_with_dam.png)
...
![](../../inst/extdata/shiny_app_tutorial/images/breeding_group_first_group_no_kinship_seeds_indicated.png)
