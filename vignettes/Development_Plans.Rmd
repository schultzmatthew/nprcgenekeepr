...
```
## To do
1. The __checkParentSex__ function stops the application if a sire is 
    also a dam in the pedigree. It would be better if an error message was sent
    to the user, the program did not stop, the program did not allow the 
    pedigree to processed, the user was prompted to enter a corrected data set.
2. It would be better to catalogue and report the changes made by qc.Studbook()
