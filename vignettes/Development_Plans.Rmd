...
nprcmanager.log. Currently I am only logging events occurring the the 
server.R file, because that is where I tend to have most of my problems show up. 
I have attached an example file in which turned on logging at the debug level
...
functions have no tests at all. -- Have 86.32% as of 20180429
...
(From page 29 of \emph{PMx User Manual, version 1.0}).
