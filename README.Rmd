...
# nprcmanager
```{r child = "vignettes/_introduction.Rmd", ref = "introduction"}
```
```{r child = "vignettes/_installation.Rmd", ref = "installation"}
```
```{r child = "vignettes/_summary_of_major_functions.Rmd", ref = "summary_of_functions"}
```
```{r child = "vignettes/_running_shiny_application.Rmd", ref = "running_shiny_application"}
```
