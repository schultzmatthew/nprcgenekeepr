...
1.  Discussed layout of breeding group formation tab by using a mockup tool.
    ...
    interface elements needed within the selected workflow.

1.  Need to test group formation with an animal not in the pedigree or
    not in the genetic analysis.
    Make an error reporting function that informs the user what has occurred.

1.  Change "Animals will be ignored below this age" to "Animals will be 
    grouped with the mother below age". 

1.  Change to Animals with kinship above this value will be excluded.

1.  Change to Include kinship in display of groups
...
1.  Have 6 boxes for seed animals. User can provide seed animals for upto six animals.
