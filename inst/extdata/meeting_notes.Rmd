...
3.  Check the outliers found in the first box and whisker plot when the file
    "Example_Pedigree.csv" is analyzed.
...
5.  Add the ability to use harems 1 male and any number of females. One way 
    to do this would be to put any number of males in with the females in 
...
7.  We reaffirmed the plan for Mark to finish the tutorials (one for an
...
8.  The next meeting is scheduled for 11-26-2018.
