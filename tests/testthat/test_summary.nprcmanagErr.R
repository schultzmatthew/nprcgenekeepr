...
test_that("summary.nprcmanagErr provides expected classes of output", {
...
test_that("summary.nprcmanagErr provides expected output", {
...
test_that("summary.nprcmanagErr identifies individual bad dates in date columns", {
...
test_that("summary.nprcmanagErr identifies bad database connection", {
  birth <- as.character(pedOne$birth_date, format = "%Y-%m-%d")
  birth[5] <- "04-02-2015"
  birth[6] <- "03-17-2009"
  pedEight <- pedOne
